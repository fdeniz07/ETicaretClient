...
const routes: Routes = [
  {
    //Eger sayfa yapimiz birden fazla layout kullaniyorsa, path kismina layout adi girilir, sonrasinda gelen sayfalarin children oldugu belirtilerek nesne türünde cagrilir.
    path: "admin", component: LayoutComponent, children: [
      { path: "", component: DashboardComponent, canActivate: [AuthGuard] },//Ilgili layouta bagli ana sayfa niteligindeki alanlarin path kismi bos, component adi gelir
  ...
  { path: "", component: HomeComponent },//Ana layoutumuzun adini bos birakiyoruz //Ana layout tetiklendiginde ilk acilacak component adi girilir
